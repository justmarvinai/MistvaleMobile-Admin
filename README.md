...
**Status: Phases A0–A1 shipped.** Auth, app shell, dashboard, publish center, the generic entity browser for all 21 content types, and the Game config / Champion / Skills editors are built and tested. Next: A2 (campaign, drop tables, balance sandbox, battle inspector).
